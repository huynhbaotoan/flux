...
replace github.com/fluxcd/helm-operator => github.com/fluxcd/helm-operator v1.0.0-rc5
...
require (
	...
	k8s.io/api v0.0.0-20191016110408-35e52d86657a // kubernetes-1.14.4
	k8s.io/apiextensions-apiserver v0.0.0-20191016113550-5357c4baaf65 // kubernetes-1.14.4
	k8s.io/apimachinery v0.0.0-20191004115801-a2eda9f80ab8 // kubernetes-1.14.4
